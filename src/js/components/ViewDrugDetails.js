          ...
          <div className="page" style={{paddingTop:'10px'}}>
            ...
            <div >
              ...
              <div name="MedImpactRow" className="row competitorRow">
                ...
                <div className=" col-xs-12 col-sm competitors pharmacy rest">{this.state.drugDetails && this.state.drugDetails != "N/A" ? this.state.drugDetails.programs[3].prices[0].pharmacy : "N/A"}</div>
                <div className=" col-xs-12 col-sm competitors price rest " style={singleCarePriceColor}>
                  <span className="compPrice">
                    <span ></span>
                    {this.state.drugDetails && this.state.drugDetails.programs[3].prices[0].price != "N/A" ? "$" + this.round(this.state.drugDetails.programs[3].prices[0].price) : "N/A"}</span> <br />
                  <span className="diff">
                    <span style={{ display: 'inline-flex' }}><Arrow diff={this.state.drugDetails ? this.state.drugDetails.programs[3].prices[0].diff : 0}></Arrow>{this.state.drugDetails && this.state.drugDetails.programs[3].prices[0].diff != "N/A" ? this.round(this.state.drugDetails.programs[3].prices[0].diff) : "N/A"}</span >
                  </span ></div >
              </div >
              <div name="WellRxRow" className="row competitorRow">
                ...
                <div className=" col-xs-12 col-sm competitors pharmacy rest">{this.state.drugDetails && this.state.drugDetails != "N/A" ? this.state.drugDetails.programs[2].prices[0].pharmacy : "N/A"}</div>
                <div className=" col-xs-12 col-sm competitors price rest " style={wellRxPriceColor}>
                  <span className="compPrice ">
                    <span ></span>
                    {this.state.drugDetails && this.state.drugDetails.programs[2].prices[0].price != "N/A" ? "$" + this.round(this.state.drugDetails.programs[2].prices[0].price) : "N/A"}</span> <br />
                  <span className="diff">
                    <span style={{ display: 'inline-flex' }}><Arrow diff={this.state.drugDetails ? this.state.drugDetails.programs[2].prices[0].diff : 0}></Arrow>{this.state.drugDetails && this.state.drugDetails.programs[2].prices[0].diff != "N/A" ? this.round(this.state.drugDetails.programs[2].prices[0].diff) : "N/A"}  </span >
                  </span ></div >
              </div >
              <div name="UsPharmacyCardRow" className="row competitorRow">
                ...
                <div className=" col-xs-12 col-sm competitors pharmacy rest">{this.state.drugDetails && this.state.drugDetails.programs[1].prices[0].pharmacy != "N/A" ? this.state.drugDetails.programs[1].prices[0].pharmacy : "N/A"}</div>
                <div className=" col-xs-12 col-sm competitors price rest " style={usPharmCardPriceColor}>
                  <span className="compPrice ">
                    <span ></span>
                    {(this.state.drugDetails && this.state.drugDetails.programs[1].prices[0].price != "N/A") ? "$" + this.round(this.state.drugDetails.programs[1].prices[0].price) : "N/A"}</span> <br />
                  <span className="diff">
                    <span style={{ display: 'inline-flex' }}><Arrow diff={this.state.drugDetails ? this.state.drugDetails.programs[1].prices[0].diff : 0}></Arrow> {(this.state.drugDetails && this.state.drugDetails.programs[1].prices[0].diff != "N/A") ? this.round(this.state.drugDetails.programs[1].prices[0].diff) : "N/A"}</span >
                  </span ></div >
              </div >
              <div name="BlinkHealthRow" className="row competitorRow">
                ...
                <div className=" col-xs-12 col-sm competitors pharmacy rest">{this.state.drugDetails && this.state.drugDetails.programs[5].prices[0].pharmacy != "N/A" ? this.state.drugDetails.programs[5].prices[0].pharmacy : "N/A"}</div>
                <div className=" col-xs-12 col-sm competitors price rest " style={blinkPriceColor}>
                  <span className="compPrice ">
                    <span ></span>
                    {(this.state.drugDetails && this.state.drugDetails.programs[5].prices[0].price != "N/A") ? "$" + this.round(this.state.drugDetails.programs[5].prices[0].price) : "N/A"}</span> <br />
                  <span className="diff">
                    <span style={{ display: 'inline-flex' }}><Arrow diff={this.state.drugDetails ? this.state.drugDetails.programs[5].prices[0].diff : 0}></Arrow> {(this.state.drugDetails && this.state.drugDetails.programs[5].prices[0].diff != "N/A") ? this.round(this.state.drugDetails.programs[5].prices[0].diff) : "N/A"}</span >
                  </span ></div >
              </div >
              <div name="GoodRxRow" className="row competitorRow">
                ...
                <div className=" col-xs-12 col-sm competitors pharmacy rest">{this.state.drugDetails && this.state.drugDetails != "N/A" ? this.state.drugDetails.programs[6].prices[0].pharmacy : "N/A"}</div>
                <div className=" col-xs-12 col-sm competitors price rest " style={singleCarePriceColor}>
                  <span className="compPrice">
                    <span ></span>
                    {this.state.drugDetails && this.state.drugDetails.programs[6].prices[0].price != "N/A" ? "$" + this.round(this.state.drugDetails.programs[6].prices[0].price) : "N/A"}</span> <br />
                  <span className="diff">
                    <span style={{ display: 'inline-flex' }}><Arrow diff={this.state.drugDetails ? this.state.drugDetails.programs[6].prices[0].diff : 0}></Arrow>{this.state.drugDetails && this.state.drugDetails.programs[6].prices[0].diff != "N/A" ? this.round(this.state.drugDetails.programs[6].prices[0].diff) : "N/A"}</span >
                  </span ></div >
              </div >
            </div >
          </div >
