                ...
                <div style={{ paddingLeft: '10%', paddingRight: '10%' }}>
                                ...
                                <tr>
                                    ...
                                    >
                                        <div style={{ display: 'inline-flex' }}>
                                            <label className='dashboardTableHeader' style={{ float: 'left' }}>Drug</label>
                                    ...
                                    >
                                        <div style={{ display: 'inline-flex' }}>
                                            <label className='dashboardTableHeader' style={{ float: 'left' }}>Current Price</label>
                                            <div style={{ float: 'left' }}>
                                                {' '}
                                                <Icons
                                    ...
                                    >
                                        <div style={{ display: 'inline-flex' }}>
                                            <label className='dashboardTableHeader' style={{ float: 'left' }}>
                                    ...
                                    >
                                        <div style={{ display: 'inline-flex' }}>
                                            <label className='dashboardTableHeader' style={{ float: 'left' }}>Well Rx Price</label>
                                            <div style={{ float: 'left' }}>
                                                {' '}
                                                <Icons
                                    ...
                                    >
                                        <div style={{ display: 'inline-flex' }}>
                                            <label className='dashboardTableHeader' style={{ float: 'left' }}>MedImpact Price</label>
                                            <div style={{ float: 'left' }}>
                                                {' '}
                                                <Icons
                                    ...
                                    >
                                        <div style={{ display: 'inline-flex' }}>
                                            <label className='dashboardTableHeader' style={{ float: 'left' }}>SingleCare Price</label>
                                            <div style={{ float: 'left' }}>
                                                {' '}
                                                <Icons
                    ...
                    <div style={{ paddingRight: '0px', paddingTop: '15px' }}>
                        <div className="float-sm-right">
                            <button type="button" style={{ marginRight: '10px', display: 'flex' }} onClick={() => { this.exportDrugs() }} className="btn btn-outline-primary">
                                <CloudDownloadIcon style={{paddingRight: 5}}/>Export</button>
                        </div>
                    </div>
                </div>
            </div>
